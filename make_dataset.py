...
OUTPUT_CSV_FILE = "owid-energy-data.csv"
OUTPUT_EXCEL_FILE = "owid-energy-data.xlsx"
OUTPUT_JSON_FILE = "owid-energy-data.json"
CODEBOOK_FILE = "owid-energy-codebook.csv"
